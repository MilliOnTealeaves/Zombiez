...
public class Animator
{
	...
	public void drawMap(int pRow, int pCol)
	{
		...
		Utility.selectTextStyle(Style.REGULAR, Style.INTENSE, Style.GREEN);
		Utility.writePos("[]", top+17, left+42);
		Utility.selectTextStyle(Style.REGULAR, Style.INTENSE, Style.BLUE);
		Utility.writePos("<>" + Utility.RESET, top+2+pRow*3, left+pCol*6+7);
	}
